...
for i:=0 to Length(energyscan)-1 do begin
if energyscan[i]<>'' then Form45.Chart1.Series[0].AddXY(i,StrToFloat(energyscan[i]),'',clRed);
end;
...
if energyscan_mult[basket[Form44.ComboBox1.ItemIndex],i]<>'' then  Form45.Chart1.Series[0].AddXY(coord,StrToFloat(energyscan_mult[basket[Form44.ComboBox1.ItemIndex],i]),'',clRed);
end;
end
...
for i:=0 to Length(energyscan_mult[basket[Form44.ComboBox1.ItemIndex]])-1 do begin
  if energyscan_mult[basket[Form44.ComboBox1.ItemIndex],i]='' then Break;
if energyscan_mult[basket[Form44.ComboBox1.ItemIndex],i]<>'' then  Form45.Chart1.Series[0].AddXY(i,StrToFloat(energyscan_mult[basket[Form44.ComboBox1.ItemIndex],i]),'',clRed);
end;
