...
////////////////////БЛОК ПРИСВОЕНИЯ ИМЕН И ЭНЕРГИЙ ЭЛЕМЕНТАМ МАССИВА Enpoint и Namepoint
if pos2=true then begin    // если форма открыта при открывании файла DGR и переходим в конец
...
//////////////////////////БЛОК ПОЛУЧЕНИЯ ИМЕН И ЭНЕРГИЙ БЕЗ ПОВТОРОВ NPoint и Epoint
s:=0;
...
EDst1[i].Width:=30;
EDst1[i].Top:=5+i*20;
EDst1[i].Text:=inttostr(i);         //позиция на канве (расположение)

EDst2[i].Left:=EDst1[i].Left+EDst1[i].Width+25;
EDst2[i].Width:=30;
EDst2[i].Top:=5+i*20;
EDst2[i].Text:=inttostr(i);         //порядковый номер для идентификации

EDst3[i].Left:=EDst2[i].Left+EDst2[i].Width;
EDst3[i].Width:=140;
EDst3[i].Top:=5+i*20;
EDst3[i].Text:=Npoint[i];           //имя

EDst4[i].Left:=EDst3[i].Left+EDst3[i].Width;
EDst4[i].Width:=60;
EDst4[i].Top:=5+i*20;
EDst4[i].Text:=floattostr(RoundTo(strtofloat(Epoint[i]),-1));           //энергия
...
//////////////////////////////вкладка надписи (точки)
///////////////////////////1.1 наименование стационарных точек и их свойства
...
CBst7[i].ItemIndex:=1;              //текст или ничего

EDst7[i].Left:=CBst7[i].Left+CBst7[i].Width+20;
EDst7[i].Width:=30;
EDst7[i].Top:=5+i*20;
EDst7[i].Text:=inttostr(i);         //номер  точки

EDst8[i].Left:=EDst7[i].Left+EDst7[i].Width;
EDst8[i].Width:=140;
EDst8[i].Top:=5+i*20;
EDst8[i].Text:=Npoint[i];           //имя точки
...
CBst8[i].ItemIndex:=0;           // шрифт

CBst9[i].Left:=CBst8[i].Left+CBst8[i].Width;
CBst9[i].Width:=65;
CBst9[i].Top:=5+i*20;
CBst9[i].Items.Add('8 пт');
CBst9[i].Items.Add('9 пт');
CBst9[i].Items.Add('10 пт');
CBst9[i].Items.Add('11 пт');
CBst9[i].Items.Add('12 пт');
CBst9[i].Items.Add('13 пт');
CBst9[i].Items.Add('14 пт');
CBst9[i].ItemIndex:=2;
...
///////////////////////////////1.2 энергии точек и их свойства
...
CBst11[i].ItemIndex:=1;              //текст или ничего

EDst9[i].Left:=CBst11[i].Left+CBst11[i].Width+20;
EDst9[i].Width:=30;
EDst9[i].Top:=5+i*20;
EDst9[i].Text:=inttostr(i);         //номер  точки

EDst10[i].Left:=EDst9[i].Left+EDst9[i].Width;
EDst10[i].Width:=140;
EDst10[i].Top:=5+i*20;
EDst10[i].Text:=floattostr(RoundTo(strtofloat(Epoint[i]),-1));           //имя точки
...
CBst12[i].ItemIndex:=0;           // шрифт

CBst13[i].Left:=CBst12[i].Left+CBst12[i].Width;
CBst13[i].Width:=65;
CBst13[i].Top:=5+i*20;
CBst13[i].Items.Add('8 пт');
CBst13[i].Items.Add('9 пт');
CBst13[i].Items.Add('10 пт');
CBst13[i].Items.Add('11 пт');
CBst13[i].Items.Add('12 пт');
CBst13[i].Items.Add('13 пт');
CBst13[i].Items.Add('14 пт');
...
/////////////////////////////1.3. Прочая информация и ее свойства
...
CBst15[i].ItemIndex:=0;              //текст или ничего

EDst11[i].Left:=CBst15[i].Left+CBst15[i].Width+20;
EDst11[i].Width:=30;
EDst11[i].Top:=5+i*20;
EDst11[i].Text:=inttostr(i);         //номер  точки

EDst12[i].Left:=EDst11[i].Left+EDst11[i].Width;
EDst12[i].Width:=140;
EDst12[i].Top:=5+i*20;
EDst12[i].Text:=inttostr(i);           //имя точки
...
CBst16[i].ItemIndex:=0;           // шрифт

CBst17[i].Left:=CBst16[i].Left+CBst16[i].Width;
CBst17[i].Width:=65;
CBst17[i].Top:=5+i*20;
CBst17[i].Items.Add('8 пт');
CBst17[i].Items.Add('9 пт');
CBst17[i].Items.Add('10 пт');
CBst17[i].Items.Add('11 пт');
CBst17[i].Items.Add('12 пт');
CBst17[i].Items.Add('13 пт');
CBst17[i].Items.Add('14 пт');
...
CBst19[i].ItemIndex:=1;              //текст или ничего

EDst13[i].Left:=CBst19[i].Left+CBst19[i].Width+20;
EDst13[i].Width:=30;
EDst13[i].Top:=5+i*20;
EDst13[i].Text:=EDst5[i].Text;         // реагент
...
EDst14[i].Width:=30;
EDst14[i].Top:=5+i*20;
EDst14[i].Text:=EDst6[i].Text;           //продукт

EDst15[i].Left:=EDst14[i].Left+EDst14[i].Width+5;
EDst15[i].Width:=60;
EDst15[i].Top:=5+i*20;
EDst15[i].Text:=floattostr(strtofloat(EDst4[strtoint(EDst14[i].Text)].Text)-strtofloat(EDst4[strtoint(EDst13[i].Text)].Text));  /////////////////////////////СЮДА ЭНЕРГИЮ ПЕРЕХОДА!!!!!
...
CBst20[i].ItemIndex:=0;           // шрифт

CBst21[i].Left:=CBst20[i].Left+CBst20[i].Width;
CBst21[i].Width:=65;
CBst21[i].Top:=5+i*20;
CBst21[i].Items.Add('8 пт');
CBst21[i].Items.Add('9 пт');
CBst21[i].Items.Add('10 пт');
CBst21[i].Items.Add('11 пт');
CBst21[i].Items.Add('12 пт');
CBst21[i].Items.Add('13 пт');
CBst21[i].Items.Add('14 пт');
...
delitem[s]:=i;                          // массив удаляемых переходов
s:=s+1;
end
else begin
...
///////////////////// АНАЛОГИЧНО ДЛЯ НАДПИСЕЙ ПЕРЕХОДОВ - УДАЛЕНИЕ
//////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////
/////////////////////// ИЗ SCROLLBOX6////////////////////////////////////
///////////////////////////////////////////////////////////////////////////
...
// после удаления секция надписей над стрелочками просто переписывается: все переменные удаляются и новый набор пишется

//Сохраним параметры переходов в временных массивах
...
for i:=0 to length(EDst13)-1 do begin     // сначала удаляем все элементы
...
CBst19[i].Items.Add('None');
CBst19[i].Items.Add('Text');
CBst19[i].ItemIndex:=CBst19[i].Items.IndexOf(CBst19tmp[othitem[i]]);              //текст или ничего
...
CBst20[i].Items.Add('Times New Roman');
CBst20[i].Items.Add('Courier New');
CBst20[i].ItemIndex:= CBst20[i].Items.IndexOf(CBst20tmp[othitem[i]]);           // шрифт
...
var p,posi,pos15,pos16,pos17,pos18,sp: word;    //pos15,pos16,pos17 - позиция в inputbox
vlinp: string;
d: integer;
label 0;
begin
...
vlinp:=inputbox('Ввод параметров элементарных реакций','Укажите номера точек, соответствующих реагентам и продуктам в формате A B',vlinp);
...
if (copy(vlinp,sp,1)=' ') then pos15:=pos15+1         //пробелы до элемента
else break;
end;
for sp:=1 to length(vlinp) do  begin
if (copy(vlinp,pos15+sp,1)<>' ') then pos16:=pos16+1       //элемент
else break;
end;
for sp:=1 to length(vlinp) do  begin
if (copy(vlinp,pos15+pos16+sp,1)=' ') then pos17:=pos17+1      //пробелы элемент-флаг или элемент-первая координата
else break;
end;
for sp:=1 to length(vlinp) do  begin
if (copy(vlinp,pos15+pos16+pos17+sp,1)<>' ') then pos18:=pos18+1   //флаг или 1-ая координата
else break;
end;
...
//// в секцию надписей над стрелочками тоже должна автоматически добавляться строчка
///////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////
...
CBst19[p].ItemIndex:=1;              //текст или ничего

EDst13[p].Left:=CBst19[p].Left+CBst19[p].Width+20;
EDst13[p].Width:=30;
EDst13[p].Top:=5+p*20;
EDst13[p].Text:=EDst5[p].Text;         // реагент
...
EDst14[p].Width:=30;
EDst14[p].Top:=5+p*20;
EDst14[p].Text:=EDst6[p].Text;           //продукт

EDst15[p].Left:=EDst14[p].Left+EDst14[p].Width+5;
EDst15[p].Width:=60;
EDst15[p].Top:=5+p*20;
EDst15[p].Text:=floattostr(strtofloat(EDst4[strtoint(EDst14[p].Text)].Text)-strtofloat(EDst4[strtoint(EDst13[p].Text)].Text));  /////////////////////////////СЮДА ЭНЕРГИЮ ПЕРЕХОДА!!!!!
...
CBst20[p].ItemIndex:=0;           // шрифт

CBst21[p].Left:=CBst20[p].Left+CBst20[p].Width;
CBst21[p].Width:=65;
CBst21[p].Top:=5+p*20;
CBst21[p].Items.Add('8 пт');
CBst21[p].Items.Add('9 пт');
CBst21[p].Items.Add('10 пт');
CBst21[p].Items.Add('11 пт');
CBst21[p].Items.Add('12 пт');
CBst21[p].Items.Add('13 пт');
CBst21[p].Items.Add('14 пт');
...
// надо сделать Update надписей направлений


//но сначала проверить, может уже все добавилось,
//повторный Update приводит к сборсу установленных параметров

if length(EDst13)=0 then goto 10;

if length(EDst5)=length(EDst13) then begin
EDst13[length(EDst13)-1].Text:=EDst5[length(EDst13)-1].Text;         // реагент
EDst14[length(EDst13)-1].Text:=EDst6[length(EDst13)-1].Text;           //продукт
...
10:
if length(EDst5)<1 then begin showmessage('Не указано ни одного элементарного превращения'); goto 0; end;
Form22.Show;
...
EDst15[i].Text:=floattostr(strtofloat(EDst4[n].Text)-strtofloat(EDst4[m].Text));  /////////////////////////////СЮДА ЭНЕРГИЮ ПЕРЕХОДА!!!!!
end;
end;
end;
